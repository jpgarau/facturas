...
switch ($metodo) {
    ...
    case 'POST':
        try {
            ...
            $estado_presu    = $datos['estado_presu'];
            ...
            $oPresupuestoC = new PresupuestosC();
            $retorno = $oPresupuestoC->agregarPresupuesto($tipo_presu, $presupuesto, $fecha, $idpresventa, $num_doc, $importe, $nombre_pdf, $estado_fact);
            if ($retorno['exito']) {
                $retorno = guardarPdf();
                if ($retorno['exito']) {
